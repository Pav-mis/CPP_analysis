...
e_phenotype = coords[coords['name'].str.contains('effector')]
...
fig, axs = plt.subplots(2, 2, figsize=(55, 25))

e_cys = axs[0, 0].hist2d(e_x_cys, e_y_cys, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Blues', alpha=0.5)
e_cpp = axs[0, 0].hist2d(e_x_cpp, e_y_cpp, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Reds', alpha=0.5)
e_cut = axs[0, 0].hist2d(e_x_cutsites, e_y_cutsites, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Greys', alpha=0.5)
e_motifs = axs[0, 0].hist2d(e_x_motifs, e_y_motifs, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Greens', alpha=0.5)
e_signal = axs[0, 0].hist2d(e_x_signal, e_y_signal, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Purples', alpha=0.5)
axs[0, 0].set_ylim([0, max_length])
axs[0, 0].set_xlim([0, 1])
axs[0, 0].set_title('effector_phenotype')
cbar1 = plt.colorbar(e_cys[3], ax=axs[0, 0])
cbar1.set_label('Cys density')
cbar2 = plt.colorbar(e_cpp[3], ax=axs[0, 0])
cbar2.set_label('CPP density')
cbar3 = plt.colorbar(e_cut[3], ax=axs[0, 0])
cbar3.set_label('Cutsite density')
cbar4 = plt.colorbar(e_motifs[3], ax=axs[0, 0])
cbar4.set_label('Motif density')
cbar5 = plt.colorbar(e_signal[3], ax=axs[0, 0])
cbar5.set_label('Signal density')
axs[0, 0].set_ylabel('Length')
axs[0, 0].set_xlabel('Position relative to length')
...
control_cys = axs[1, 1].hist2d(control_x_cys, control_y_cys, bins = [np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Blues', alpha=0.5)
control_cpp = axs[1, 1].hist2d(control_x_cpp, control_y_cpp, bins = [np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Reds', alpha=0.5)
control_cut = axs[1, 1].hist2d(control_x_cutsites, control_y_cutsites, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Greys', alpha=0.5)
control_motifs = axs[1, 1].hist2d(control_x_motifs, control_y_motifs, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Greens', alpha=0.5)
control_signal = axs[1, 1].hist2d(control_x_signal, control_y_signal, bins=[np.arange(0, 1, 0.005), np.arange(0, max_length, 25)], cmin = 1, cmap='Purples', alpha=0.5)
axs[1, 1].set_ylim([0, max_length])
axs[1, 1].set_xlim([0, 1])
axs[1, 1].set_title('control_phenotype')
cbar16 = plt.colorbar(control_cys[3], ax=axs[1, 1])
cbar16.set_label('Cys density')
cbar17 = plt.colorbar(control_cpp[3], ax=axs[1, 1])
cbar17.set_label('CPP density')
cbar18 = plt.colorbar(control_cut[3], ax=axs[1, 1])
cbar18.set_label('Cutsite density')
cbar19 = plt.colorbar(control_motifs[3], ax=axs[1, 1])
cbar19.set_label('Motif density')
cbar20 = plt.colorbar(control_signal[3], ax=axs[1, 1])
cbar20.set_label('Signal density')
axs[1, 1].set_ylabel('Length')
axs[1, 1].set_xlabel('Position relative to length')
